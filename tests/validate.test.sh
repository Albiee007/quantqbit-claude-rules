...
fresh; printf '\x89PNG\r\n' > "$W/r/harness/skills/store-mockups/templates/shot.png"
expect_fail "binary file in harness"   "binary file in harness"
fresh; printf 'def x(:\n' > "$W/r/harness/skills/store-listing/scripts/broken.py"
expect_fail "python syntax error"       "python syntax error"
fresh; printf 'a\r\nb\r\n' >> "$W/r/harness/skills/store-mockups/templates/frame.html"
expect_fail "CRLF in html template"     "CRLF line endings"
